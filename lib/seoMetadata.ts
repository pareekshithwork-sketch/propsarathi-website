...
export const seoConfig: SEOConfig = {
  ...
  pages: {
    ...
    contact: {
      ...
      description:
        "Ready to invest in Dubai or Bangalore real estate? Contact PropSarathi for personalized investment advisory. Call +971-XXX-XXXX (Dubai) or +91-XXX-XXXX (Bangalore). Free consultation available.",
      keywords: [
        "contact PropSarathi",
