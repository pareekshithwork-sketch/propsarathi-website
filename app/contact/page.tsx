    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-5">
          ...
          {[
            { icon: <Phone className="w-5 h-5" />, label: "Call / WhatsApp", value: "+91 70903 03535", href: "tel:+917090303535", color: "bg-green-50 text-green-600" },
            ...
            { icon: <Mail className="w-5 h-5" />, label: "Email", value: "enquiry@propsarathi.com", href: "mailto:enquiry@propsarathi.com", color: "bg-blue-50 text-blue-600" },
